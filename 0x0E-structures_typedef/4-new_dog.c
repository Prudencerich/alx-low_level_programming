...
/**
  ...
  *
  * @s: String to count in the program.
  *
...
/**
  * _strcpy - Copy a string function in the program.
  *
  * @dest: Destination value in the program
  *
  * @src: Source value function in the program
  *
  * Return: the pointer to dest function in the program.
  */
char *_strcpy(char *dest, char *src)
{
	int i;
